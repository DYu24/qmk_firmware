...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_WINDOWS] = LAYOUT_65_ansi_blocker(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                             KC_LALT, MO(_FN), KC_LEFT, KC_DOWN, KC_RGHT  \
    ),
    ...
    [_FN] = LAYOUT_65_ansi_blocker(
        ...
        _______, _______, _______,                            _______,                        MO(_CONFIG), _______, KC_HOME, KC_PGDN, KC_END   \
    ),
    [_CONFIG] = LAYOUT_65_ansi_blocker(
        ...
        _______, RGB_RMOD,RGB_VAD, RGB_MOD, RGB_HUD, RGB_SAD, _______, _______, _______, LYR_TOG, _______, _______,          _______, _______, \
...
layer_state_t default_layer_state_set_kb(layer_state_t state) {
    //uprintf("calling default_layer_state_set_kb %ld\n", state);
